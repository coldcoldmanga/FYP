...
const AdminBottomNavBar = ({ activeTab, setActiveTab}: AdminBottomNavBarProps) => {
    return (
        <View style={styles.bottomNav}>
            ...
            >
                <Icon 
                    name="build" 
                    size={24} 
                    color={activeTab === 'Facility' ? '#4A90E2' : '#666'} 
                />
                <Text style={[styles.navText, activeTab === 'Facility' && styles.activeNavText]}>
                    Facility
                </Text>
            </TouchableOpacity>
